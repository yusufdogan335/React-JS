...
//-- Default value added and exported
//-- Imported for used components
//-- Used contextType related component,
//-- And used this.context


//2 => Provider --> Consumer
//-- Class component oluşturuldu, veri state içerisine alındı,
//-- Context e ait Provider ile state de bulunan veri alındı,
//-- Parend child ilişkisi {this.props.children} ile sağlandı,
//-- Veriyi göndereceğimiz component a context i import ediyoruz,
//-- Render içerisinde Consumer ile Provider den gelen veriyi yakalıyoruz.
